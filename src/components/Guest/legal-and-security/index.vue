<template>
  <div id="logal_security">
    <v-header/>
    <v-legal-and-security-documents/>
...
export default {
  name: "index",
  components: {VLicensesAndCertificates, VFooterMenu, VLegalAndSecurityDocuments, VHeader,VQuickCommunicationBlock}
}
</script>
